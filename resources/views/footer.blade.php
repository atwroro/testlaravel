             ...
             <div class="col-md-12 footer-top">
                 ...
                 <div class="row block-footer-2">
                     ...
                     <div class="col-xs-6 col-sm-6 col-md-4 footer-about">
                         <h3>Về chúng tôi</h3>
                         <p>Trang web đăng tin chia sẻ miễn phí thông tin về phòng trọ, nhà riêng, văn phòng nhằm
                             giúp người thuê phòng và người cho thuê phòng tương tác với nhau không qua trung gian
                             môi giới.</p>
                     </div>
                     <div class="col-xs-6 col-sm-6 col-md-4 footer-tag">
                         <h3>Top từ khóa</h3>
                         <p>
                             <a href="phong-tro-nha-tro">Tìm phòng trọ</a>,
                             <a href="phong-tro-nha-tro">Tìm nhà trọ</a>,
                             <a href="phong-tro-nha-tro">Cho thuê nhà trọ</a>,
                             <a href="phong-tro-nha-tro">Cho thuê phòng trọ</a>,
                             <a href="nha-nguyen-can">Cho thuê nhà nguyên căn</a>,
                             <a href="nha-nguyen-can">Thuê nhà nguyên căn</a>,
                             <a href="nha-nguyen-can">Nhà cho thuê</a>,
                             <a href="chung-cu-can-ho">Cho thuê chung cư mini</a>,
                             <a href="o-ghep">Tìm người ở ghép</a>,
