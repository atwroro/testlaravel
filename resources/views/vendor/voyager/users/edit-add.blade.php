                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="full_name" name="full_name"
                                        placeholder="Họ và tên" value="{{ $dataTypeContent->full_name ?? '' }}">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="phone_number" name="phone_number"
                                        placeholder="Số điện thoại" value="{{ $dataTypeContent->phone_number ?? '' }}">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="CMND" name="CMND"
                                        placeholder="Số CMND" value="{{ $dataTypeContent->CMND ?? '' }}">
                                </div>
                            </div>
                        </div>
